...
export const PAINTINGS: Painting[] = [
  {
    ...
    caption:
      "A swirling night sky over a small French village, with glowing stars and a crescent moon above rolling hills.",
  ...
  },
  {
    ...
    caption:
      "A late-night diner interior on a deserted city corner, with three customers and a server beneath fluorescent light.",
  ...
  },
  {
    ...
    caption:
      "A lone figure on a rocky precipice overlooking a vast sea of misty mountain peaks stretching to the horizon.",
    style: "Romanticism",
  },
  {
    id: "mona-lisa",
    ...
    caption:
      "A half-length portrait of a woman with an enigmatic smile, seated before a distant imaginary landscape with winding paths and bridges.",
    style: "Renaissance",
  },
  {
    id: "great-wave",
    ...
    caption:
      "A towering wave curling above three fishing boats, with Mount Fuji small in the distance beneath the foam.",
    style: "Ukiyo-e",
  },
  {
    id: "paris-street",
    ...
    caption:
      "A wide Parisian intersection on a wet day, with figures under umbrellas crossing the cobblestones between Haussmann buildings.",
    style: "Impressionism",
  },
  {
    id: "scream",
    ...
    caption:
      "A figure on a bridge beneath a swirling orange sky, hands clasped to ears, with two distant figures walking away.",
    style: "Expressionism",
  },
  {
    id: "water-lilies",
    ...
    caption:
      "A pond surface covered in green lily pads and scattered pink and white blooms, reflecting the sky and surrounding willows.",
    style: "Impressionism",
  },
  {
    id: "school-of-athens",
    ...
    caption:
      "A grand vaulted hall filled with ancient philosophers in discussion, framed by towering classical arches and marble statues.",
  ...
  },
  {
    ...
    caption:
      "A fantastical triptych of paradise, earthly life, and hell — filled with surreal creatures, bizarre architectures, and dreamlike landscapes.",
  ...
  },
  {
    ...
    caption:
      "A warmly lit outdoor café on a cobbled square under a deep blue starry sky, with figures seated at small round tables.",
    style: "Post-Impressionism",
  },
  {
    id: "birth-of-venus",
    ...
    caption:
      "Venus standing on a giant scallop shell at sea, blown to shore by wind gods, with a spring goddess offering a cloak.",
  ...
  },
  {
    ...
    caption:
      "Melting clocks draped over a barren dreamscape with a cliff-like horizon, a dead tree, and a strange central creature.",
    style: "Surrealism",
  },
  {
    id: "american-gothic",
    ...
    caption:
      "A farmer holding a pitchfork beside his daughter in front of an iconic white farmhouse with a gothic arched window.",
    style: "Regionalism",
  },
];
