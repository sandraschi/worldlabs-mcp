			...
			<section className="relative overflow-hidden rounded-[2rem] bg-black/40 border border-slate-800 shadow-2xl group backdrop-blur-md">
				...
				<div className="relative px-8 py-16 md:px-14 md:py-24 max-w-4xl">
					...
					<p className="text-xl text-slate-400 mb-10 leading-relaxed max-w-2xl font-medium">
						Spatial Intelligence at your fingertips. Reconstruct 3D environments
						from text, images, and videos. Seamless export to Blender, Unity,
						and Resonite.
					</p>
					<div className="flex flex-wrap gap-5">
						<Link
							to="/architect"
							className="flex items-center gap-3 rounded-2xl bg-white px-8 py-4 font-black text-black hover:bg-cyan-50 transition-all transform hover:scale-105 shadow-xl shadow-cyan-500/10 no-underline"
						>
						...
						<Link
							to="/library"
							className="flex items-center gap-3 rounded-2xl border border-slate-700 bg-slate-900/50 hover:bg-slate-800 px-8 py-4 font-bold text-white transition-all backdrop-blur-md no-underline"
						>
