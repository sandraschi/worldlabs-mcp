import { 
    Zap, Rocket, Layers, Database, Cpu, 
    ChevronRight, Info, Activity, Globe2,
        ...
        <div className="space-y-12 pb-20 animate-in fade-in duration-500">
            ...
            <section className="relative overflow-hidden rounded-[2rem] bg-black/40 border border-slate-800 p-12 backdrop-blur-xl group">
                ...
                <div className="relative">
                    ...
                    <p className="text-lg text-slate-400 max-w-2xl leading-relaxed">
                        A high-performance Radiance Field renderer built for infinite-scale 3D Gaussian Splatting. 
                        Spark 2.0 introduces streaming Level-of-Detail (LoD) trees and GPU virtual memory paging.
                    </p>
                </div>
            </section>
            ...
            <div className="grid gap-6 md:grid-cols-3">
                <div className="glass-card p-8 space-y-4 hover:border-cosmos-500/50 transition-all group">
                    ...
                    <p className="text-sm text-slate-500 leading-relaxed">
                        Organizes radiance fields into hierarchical structures. Render 100M+ splats with 
                        a fixed frame-budget of 500K-2.5M primitives.
                    </p>
                </div>
                <div className="glass-card p-8 space-y-4 hover:border-aurora-500/50 transition-all group">
                    ...
                    <p className="text-sm text-slate-500 leading-relaxed">
                        A bitstream-optimized format for progressive delivery. Supports HTTP Range requests 
                        for instant coarse previews followed by progressive refinement.
                    </p>
                </div>
                <div className="glass-card p-8 space-y-4 hover:border-cyan-500/50 transition-all group">
                    ...
                    <p className="text-sm text-slate-500 leading-relaxed">
                        Swaps splat pages in/out of GPU memory based on frustum visibility. Enables 
                        massive world navigation on mobile and standalone XR hardware.
                    </p>
                </div>
            </div>
                    ...
                    <table className="w-full text-left border-collapse">
                        ...
                        <tbody className="text-xs text-slate-400">
                            <tr className="border-b border-white/[0.04] hover:bg-white/[0.02]">
                                <td className="px-8 py-4 font-bold text-slate-300">Coordinate Precision</td>
                                <td className="px-8 py-4 font-mono">ExtSplats f32</td>
                                <td className="px-8 py-4">High-Precision Radiance</td>
                            </tr>
                            <tr className="border-b border-white/[0.04] hover:bg-white/[0.02]">
                                <td className="px-8 py-4 font-bold text-slate-300">Tree Construction</td>
                                <td className="px-8 py-4 font-mono">bhatt-lod</td>
                                <td className="px-8 py-4 text-cosmos-400 font-bold">Industrial SOTA</td>
                            </tr>
                            <tr className="border-b border-white/[0.04] hover:bg-white/[0.02]">
                                <td className="px-8 py-4 font-bold text-slate-300">Compute Backend</td>
                                <td className="px-8 py-4 font-mono">Rust / Wasm Workers</td>
                                <td className="px-8 py-4">Concurrent Throughput</td>
                            </tr>
                            <tr className="hover:bg-white/[0.02]">
                                <td className="px-8 py-4 font-bold text-slate-300">Immersive Integration</td>
            ...
            <div className="grid gap-8 md:grid-cols-2">
                <div className="space-y-6">
                    <h2 className="text-2xl font-bold text-white tracking-tight">Industrial Interoperability</h2>
                    <p className="text-slate-400 text-sm leading-relaxed">
                        Spark 2.0 is designed for the modern sovereign workstation. It bypasses the 
                        bottlenecks of traditional heavy-poly rasterization by utilizing volumetric 
                        rendering primitives that better represent the "hallucinated" geometry of 
                        Marble foundation models.
                    </p>
                ...
                <div className="glass-card p-8 bg-cosmos-600/5 border-cosmos-500/20 relative isolate overflow-hidden">
                    ...
                    <h4 className="text-lg font-bold text-cosmos-300 mb-4">Industrial Context</h4>
                    <p className="text-sm text-slate-500 italic leading-relaxed">
                        "The move to LoD Splat Trees in Spark 2.0 allows us to finally decouple scene 
                        complexity from GPU memory constraints. We are no longer rendering points; 
                        we are traversing a probability volume."
                    </p>
                    <div className="mt-6 flex items-center gap-3">
                        <div className="w-8 h-8 rounded-full bg-slate-800 border border-white/10" />
                        <div>
                            <p className="text-xs font-bold text-white uppercase tracking-tighter">Engineering Lead</p>
                            <p className="text-[10px] text-slate-500 font-mono">Spark Core Team</p>
                        </div>
                    </div>
                </div>
            </div>
