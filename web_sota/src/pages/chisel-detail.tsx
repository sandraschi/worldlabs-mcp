import { 
    Shapes, Wand2, Box, PenTool, 
    ChevronRight, Info, Activity, Globe2,
    ShieldCheck, Ruler, Scale
} from 'lucide-react';
        ...
        <div className="space-y-12 pb-20 animate-in fade-in duration-500">
            ...
            <section className="relative overflow-hidden rounded-[2rem] bg-black/40 border border-slate-800 p-12 backdrop-blur-xl group">
                ...
                <div className="relative">
                    ...
                    <p className="text-lg text-slate-400 max-w-2xl leading-relaxed">
                        The geometric backbone of the World Labs ecosystem. Chisel "distills" 
                        watertight topology from volumetric radiance fields, bridging the gap 
                        between Gaussian probability and physical simulation.
                    </p>
                </div>
            </section>
            ...
            <div className="grid gap-6 md:grid-cols-3">
                ...
                <div className="glass-card p-8 space-y-4 hover:border-aurora-500/50 transition-all group">
                    ...
                    <p className="text-sm text-slate-500 leading-relaxed">
                        Multi-pass decimation ensures that generated meshes maintain 
                        visual silhouettes while adhering to standard polygon budgets.
                    </p>
                </div>
            </div>
                    ...
                    <table className="w-full text-left border-collapse">
                        ...
                        <tbody className="text-xs text-slate-400">
                            <tr className="border-b border-white/[0.04] hover:bg-white/[0.02]">
                                <td className="px-8 py-4 font-bold text-slate-300">Latent Sampling</td>
                                <td className="px-8 py-4 font-mono">Radial Volumetric Probe</td>
                                <td className="px-8 py-4">SDF (Signed Distance Field)</td>
                            </tr>
                            <tr className="border-b border-white/[0.04] hover:bg-white/[0.02]">
                                <td className="px-8 py-4 font-bold text-slate-300">Surface Distillation</td>
                                <td className="px-8 py-4 font-mono">MarbleMesh-V4</td>
                                <td className="px-8 py-4 text-void-400 font-bold">Watertight Mesh</td>
                            </tr>
                            <tr className="border-b border-white/[0.04] hover:bg-white/[0.02]">
                                <td className="px-8 py-4 font-bold text-slate-300">UV Parameterization</td>
                                <td className="px-8 py-4 font-mono">Conformal Least Squares</td>
                                <td className="px-8 py-4">Albedo / Normal Maps</td>
                            </tr>
                            <tr className="hover:bg-white/[0.02]">
                                <td className="px-8 py-4 font-bold text-slate-300">Physics Baking</td>
            ...
            <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-3">
                <div className="space-y-4">
                    ...
                    <p className="text-sm text-slate-500 leading-relaxed">
                        Gaussian Splatting is inherently volumetric and "fuzzy." While visually 
                        superior, it lacks the discrete boundary required for a physics engine 
                        to calculate where a character stands or how a car collides. 
                ...
                <div className="space-y-4">
                    ...
                    <p className="text-sm text-slate-500 leading-relaxed">
                        Every world generated via the Hub includes a Chisel-prepared 
                        `.glb` file. This allows for instant handoff to Blender, Unity, 
                        or robot simulators like NVIDIA Isaac Sim.
                    </p>
                </div>
                <div className="space-y-4">
