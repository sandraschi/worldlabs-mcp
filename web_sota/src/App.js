			...
			<react_router_dom_1.BrowserRouter>
				<app_layout_1.AppLayout>
					<react_router_dom_1.Routes>
						...
						<react_router_dom_1.Route
							path="/status"
							element={<status_1.Status />}
						/>
						<react_router_dom_1.Route
							path="/tools"
							element={<tools_1.Tools />}
						/>
						<react_router_dom_1.Route
							path="/architect"
							element={<world_gen_1.default />}
						/>
						<react_router_dom_1.Route
							path="/library"
							element={<world_viewer_1.WorldViewer />}
						/>
						<react_router_dom_1.Route
							path="/tools-explorer"
							element={<tools_explorer_1.ToolsExplorer />}
						/>
						<react_router_dom_1.Route
							path="/local-llm"
							element={<local_llm_1.LocalLlm />}
						/>
						<react_router_dom_1.Route path="/apps" element={<apps_1.Apps />} />
						<react_router_dom_1.Route path="/help" element={<help_1.Help />} />
						<react_router_dom_1.Route
							path="/settings"
							element={<settings_1.Settings />}
						/>
						<react_router_dom_1.Route
							path="*"
